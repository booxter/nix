...
in
{
  ...
  programs.thunderbird =
    lib.mkIf (userEnvironment.features.apps.enable && emailCfg.enable && emailCfg.thunderbird.enable)
      {
        enable = true;
  ...
  # Accounts
  accounts.email.accounts = lib.mkIf (userEnvironment.features.apps.enable && emailCfg.enable) (
    let
      commonCfg = {
