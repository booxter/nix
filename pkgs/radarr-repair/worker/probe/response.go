...
func convertEvidence(evidence controller.ProbeEvidence) workercontracts.Evidence {
...
func convertKind(kind *controller.ProbeStreamKind) *workercontracts.Kind {
	if kind == nil {
		return nil
	}
	converted := workercontracts.Kind(*kind)
	return &converted
}
