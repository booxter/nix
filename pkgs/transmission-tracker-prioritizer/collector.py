    ...
    while True:
        ...
        try:
            ...
            if state is None:
                ...
                LOG.info(
                    "iteration complete: tracker_hosts=%s preferred_torrents=%s preferred_bootstrap_active=%s preferred_upload_active=%s preferred_upload_bytes_per_second=%s observed_high_priority_changes=%s observed_low_priority_changes=%s",
