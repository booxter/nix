...
import (
	...
	"github.com/booxter/nix-config/media-repair/internal/dvdexecution"
	"github.com/booxter/nix-config/media-repair/internal/executioncheck"
	"github.com/booxter/nix-config/media-repair/internal/joinexecution"
	"github.com/booxter/nix-config/media-repair/internal/joinimport"
	"github.com/booxter/nix-config/media-repair/internal/manualimport"
	"github.com/booxter/nix-config/media-repair/internal/remuxexecution"
	"github.com/booxter/nix-config/media-repair/internal/remuximport"
