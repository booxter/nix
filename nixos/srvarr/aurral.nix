...
let
  ...
  aurralUnitDeps = {
    Wants = [ "network-online.target" ] ++ lib.optional cfg.soulseek.enable "slskd.service";
    After = [ "network-online.target" ] ++ lib.optional cfg.soulseek.enable "slskd.service";
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.aurral = {
      ...
      serviceConfig = {
        ...
        ++ lib.optional cfg.soulseek.enable slskdDownloadsDir;
        ProtectHome = true;
