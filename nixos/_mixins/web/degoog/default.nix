...
let
  ...
  degoogExtensions = degoogPkgs.degoog-official-extensions.override {
    ...
    extraExtensionSources = {
      "engines/devinside-devinside-degoog-osmapp-maps" =
        "${degoogPkgs.degoog-devinside-extensions}/engines/osmapp-maps";
      "engines/pross-degoog-stackexchange-engine-stackexchange" = degoogPkgs.degoog-stackexchange-engine;
      "plugins/devinside-devinside-degoog-local-history" =
        "${degoogPkgs.degoog-devinside-extensions}/plugins/local-history";
      "plugins/georgvwt-georgvwt-degoog-stuff-osm-slot" =
        "${degoogPkgs.degoog-georgvwt-extensions}/plugins/osm-slot";
      "plugins/georgvwt-georgvwt-degoog-stuff-reddit-slot" =
        "${degoogPkgs.degoog-georgvwt-extensions}/plugins/reddit-slot";
      "plugins/sopat712-degoog-toolkit-stocks" = "${degoogPkgs.degoog-toolkit-extensions}/plugins/stocks";
      "plugins/trusted-header-settings-auth" = trustedHeaderSettingsAuth;
      "themes/georgvwt-georgvwt-degoog-stuff-gruvbox-theme" =
        "${degoogPkgs.degoog-georgvwt-extensions}/themes/gruvbox";
    };
  };
  ...
  mergePluginSettingsCommand = utils.escapeSystemdExecArgs [
    (lib.getExe degoogPkgs.degoog-settings)
    "--target"
    pluginSettingsFile
    "--desired"
...
in
{
  config = lib.mkIf isOwner {
    ...
    host.sso.oauth2ProxyGates.goo = {
      ...
      cookieName = "_goo_sso";
      allowedGroups = [ degoogSso.userGroup ];
